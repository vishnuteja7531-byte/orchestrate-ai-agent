...
export const LogItem: React.FC<LogEntry> = ({ timestamp, status, message, duration }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 py-3 px-4 hover:bg-white/40 rounded-lg transition-colors group relative overflow-hidden">
      ...
      {/* Grid Content for Desktop, Stacked for Mobile */}
      <div className="flex-1 grid grid-cols-1 sm:grid-cols-12 gap-1 sm:gap-4 items-start sm:items-center">
